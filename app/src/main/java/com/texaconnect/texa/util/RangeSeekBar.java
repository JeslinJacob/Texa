...
public class RangeSeekBar<T extends Number> extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mMinLabel = getContext().getString(R.string.min_label);
        mMaxLabel = getContext().getString(R.string.max_label);
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (pressedThumb != null) {
                    ...
                    mMinLabel= String.valueOf(getSelectedMinValue());
                    mMaxLabel= String.valueOf(getSelectedMaxValue());
...
//        String maxLabel = getContext().getString(R.string.max_label);
        ...
        String minDefText = String.valueOf(getAbsoluteMinValue());
        String maxDefText = String.valueOf(getAbsoluteMaxValue());

        float minMaxLabelSize = Math.max(paint.measureText(minDefText), paint.measureText(maxDefText));
        float minMaxHeight = mTextOffset + thumbHalfHeight + mTextSize / 3;


        canvas.drawText(minDefText, 0, minMaxHeight, paint);
        canvas.drawText(maxDefText, getWidth() - minMaxLabelSize, minMaxHeight, paint);
        ...
        if (!mSingleThumb) {
            drawThumb(normalizedToScreen(normalizedMinValue), Thumb.MIN.equals(pressedThumb), canvas,
                    selectedValuesAreDefault, String.valueOf(getSelectedMinValue()));
        }

        // draw maximum thumb
        drawThumb(normalizedToScreen(normalizedMaxValue), Thumb.MAX.equals(pressedThumb), canvas,
                selectedValuesAreDefault, String.valueOf(getSelectedMaxValue()));
    ...
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas,
                           boolean areSelectedValuesDefault, String label) {
        Bitmap buttonToDraw;
        ...
        canvas.drawBitmap(buttonToDraw, screenCoord - thumbHalfWidth,
                mTextOffset,
                paint);
        if(!areSelectedValuesDefault) canvas.drawText(label, screenCoord - thumbHalfWidth, mTextOffset, paint);
